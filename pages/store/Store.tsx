  ...
  useEffect(() => {
    const getProductsByStore = async () => {
      const result = await axios(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/products/store/${storeid}`
      );
    ...
    const getStore = async () => {
      const result = await axios(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/store/get/${storeid}`
      );
    ...
    const getUploadHistoryStore = async () => {
      const result = await axios(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/upload/history/${storeid}`
      );
    ...
    const getStoreDetails = async () => {
      const result = await axios(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/store/getDetails/${storeid}`
      );
